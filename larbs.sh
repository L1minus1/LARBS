...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/L1minus1/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/L1minus1/dotfiles/master/progs.csv"
